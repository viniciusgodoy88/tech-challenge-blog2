...
async function main() {
  ...
  console.log("👤 Superusuário configurado:", superUser.email);
  ...
  console.log("👨‍🏫 Professor configurado:", teacherUser.email);
  ...
  console.log("👨‍🎓 Aluno configurado:", studentUser.email);

  // 5. Usuários dinâmicos com Faker
  ...
  console.log("👥 Usuários dinâmicos criados");
